const en = {
  ...
  "theme.label": "Theme",
  "theme.background": "Canvas Background",
  "theme.borderRadius": "Border Radius",
  "theme.padding": "Canvas Margin",
  "theme.shadow": "Shadow",
  ...
  "theme.macosBar": "macOS Bar",
  "export.scale": "Scale",
  "export.scaleHint": "Higher scale = better quality, larger file",
  "export.canvasWidth": "Canvas Width",
  "export.canvasWidthRecommended": "800px (Recommended)",
  ...
  "web.banner.text": "🎉 chat2poster is now open source!",
  ...
  "web.home.problem.title": "Why chat2poster?",
