...
1. Check if the bug has already been reported in [Issues](https://github.com/nicepkg/chat2poster/issues)
2. If not, create a new issue using the bug report template
3. Provide as much detail as possible

### Suggesting Features

1. Check if the feature has already been suggested in [Issues](https://github.com/nicepkg/chat2poster/issues)
...
Feel free to open a [Discussion](https://github.com/nicepkg/chat2poster/discussions) if you have any questions.
